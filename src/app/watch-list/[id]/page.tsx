        ...
        <div className="p-4">
            ...
            <div className="overflow-x-auto">
                {isLoading ? (
                    ...
                    <p className="text-center text-gray-500">There is no data to display. It may take time.</p>
                ) : (
                    <table className="min-w-full bg-white border border-gray-300">
                        <thead>
                            <tr className="bg-gray-100">
                                <th className="px-6 py-3 border-b text-right">time</th>
                                <th className="px-6 py-3 border-b text-right">price</th>
                                <th className="px-6 py-3 border-b text-right">value</th>
                                <th className="px-6 py-3 border-b text-right">buy/sell</th>
                            </tr>
                        </thead>
                        <tbody>
