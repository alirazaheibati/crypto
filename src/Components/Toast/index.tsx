...
const Toast:React.FC<IProps> = ({color, message}) => {

    return (
        <div className="fixed top-4 right-4 z-50">
            {color === 'red' ? (<div id="toast-danger" className="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-sm dark:text-gray-400 dark:bg-gray-800" role="alert">
